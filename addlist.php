...
$sql_fetch_todos = "SELECT * FROM cv ORDER BY id ASC";
    ...
    <div class="table-product">
        <table class="table">
            <thead class="thead-dark">
                ...
                <th scope="col">ID:Computadora/Activo</th>
        ...
        /*aqui se crea los epacios para guardarlos*/

        <div class="addproduct">
            <form method="POST" action="main/addlist.php">
                <div class="form-group">
                    <label for="exampleInputEmail1">Nombre de Computadora</label>
                    <br>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">ID:Computadora</label>
                    <br>
                    <input type="int" class="form-control" name="name" required>
                </div><br>
                <div class="form-group">
                ...
                <div class="form-button">
                    <button type="submit" class="modify" style="float:right">Agregar Computadora</button>
