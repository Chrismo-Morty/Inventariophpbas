...
<body>
    ...
    <div class="table-product">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="cambio.php?id=<?php echo $row['id'] ?> " role="button">
                                Editar
                            </a></td>
        ...
        <br>
        <a name="" id="" class="Addlist" style="float:right" href="addlist.php" role="button">Agregar Computadora</a>
        <a name="" id="" class="Addlist" style="float:right" href="Buscar.php" role="button">Buscar Computadora</a>
    </div>
    <?php
    mysqli_close($conn);
    ?>
